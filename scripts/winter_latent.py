...
def main():
    ...
    # 加载已有 Excel 文件
    wb = load_workbook("experiments/DIS_LATENT_SUMMER2WINTER.xlsx")
    ...
    # 保存修改
    wb.save("experiments/DIS_LATENT_SUMMER2WINTER.xlsx")
...
def create_argparser():
    ...
    parser.add_argument(
        "--source_model_path",
        type=str,
        default="trained_models/Summer_model2710000.pt",
        help="Path to the diffusion model weights."
    )
    parser.add_argument(
        "--target_model_path",
        type=str,
        default="trained_models/Winter_model5440000.pt",
        help="Path to the diffusion model weights."
    )
    parser.add_argument(
        "--data_source_dir",
        type=str,
        default="datasets/summer2winter/trainA",
    ...
    parser.add_argument(
        "--data_target_dir",
        type=str,
        default="datasets/summer2winter/trainB",
        help="The local directory containing ImageNet validation dataset, "
             "containing filenames like ILSVRC2012_val_000XXXXX.JPG."
    )
    parser.add_argument(
